...
int main(int argc, char *argv[]){
	...
	if (argc!=5)
	{
		std::cout<<"Using:./crtsurfdata5 inifile outpath logfile datafmt"<<std::endl;
		std::cout<<"Example:/home/project/myidc/bin/crturfdata5 /home/project/myidc/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata5.log xml,json,csv"<<std::endl;
	...
	if (logfile.Open(argv[3])==false){
		...
		logfile.Write("crtsurfdat5 开始运行！");
		//把站点参数文件加载到vstcode容器中
